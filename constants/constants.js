...
export const SEO = {
  ...
  "30-days-of-solidity": {
    ...
    image: function () {
      `${domain}/api/og?tutorial=30 DAYS OF SOLIDITY&tagline=${taglines.soliditySeries}`;
    },
    index: {
      title: "Introduction",
      description: "Introduction to the 30 Days of Solidity Series",
      image: function () {
        `${domain}/api/og?title=${this.title}&tutorial=30 DAYS OF SOLIDITY&tagline=${taglines.soliditySeries}`;
      },
    },
    "what-is-solidity": {
