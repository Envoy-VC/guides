...
Comments are used to describe your code to other developers. They're not executed by the compiler, so you can write anything you want in them. However, comments can help make your code more readable and easier to understand. There are three types of comments in Solidity: single-line, multi-line and NatSpec comments.
...
Congratulations 🥳, you've made it through and now have a better understanding of Solidity and some of its features! However, there is always more to learn and explore. Here are some resources for you to check out if you're interested in diving deeper:
