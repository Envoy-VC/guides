Welcome 👋 to **Day 3** of our 30 Days of Solidity! Today, we will be discussing variables, their types, scopes, and operators in Solidity. Variables can be categorized into different types based on their scope, such as state, local, and global. Additionally, variables can have different levels of access depending on their scope, which we will discuss today.
